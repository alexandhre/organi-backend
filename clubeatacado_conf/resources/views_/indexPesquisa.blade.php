...
<section class="section">
    ...
    <section class="section has-text-centered">
        <button id="btn-ver-mais" onclick="carregarCategorias()" class="button is-outlined is-success" style="display:none;width: 232px;margin-left: 20px"> Ver
            Mais</button>
    </section>
    <section class="section has-text-centered">
        <button id="recarregar-pagina" onclick="recarregarPagina()" class="button is-outlined is-success" style="display:none;width: 232px;margin-left: 20px"> Recarregar Página</button>
    </section>
    </div>
