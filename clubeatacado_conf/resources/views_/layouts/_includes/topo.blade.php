...
<head>
  ...
  <!-- Bulma Version 0.7.1-->
  <link rel="stylesheet" href="{{ asset('css/tendering.css') }}" />
  ...
  <script>
    function redirecionamento(rota) {
      window.location = '/clubeatacado/' + rota
    }
    ...
    <nav class="navbar" style="background-color:#17B330;min-height: 40px;">
      ...
      <div class="navbar-end">
        <div class="navbar-item has-dropdown is-hoverable">
          <a class="navbar-link" style="padding:0 0 0 0">
          ...
          <div class="navbar-dropdown" style="margin-left:-120px;">
            <a href="/clubeatacado/perfil" class="navbar-item">
              Meu Perfil
            </a>
            <a class="navbar-item" href="/clubeatacado/logout">
              Sair
            </a>           
          </div>
        </div>
      ...
      <div class="navbar-end">
        <div class="navbar-item">
          <div class="field">
            <div class="control">
              <a class="label-2" href="/clubeatacado/login">Login</a>
              <span class="label-2">/</span>
              <a class="label-2" href="/clubeatacado/registro"> Registro
              </a>
