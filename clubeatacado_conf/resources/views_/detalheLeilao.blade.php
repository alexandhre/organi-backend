    ...
    <div class="columns">
      ...
      <div class="column is-5" style="padding-left: 31px">
        ...
        <div class="media-content">
          ...
          <div class="card-content">
            ...
            <div class="media">
              <div class="media-content">
                ...
                <br>
                <br>
                <p class="subtitle is-5">Expira em: </p>
          ...
          <p class="control">
            <button class="button is-success" style="height: 48px;width: 350px;border-radius:4px">COMPRAR
              AGORA</button>
          </p>
          <br>
          <p class="control">
            <button id="myBtn" class="button gradiente is-outline" style="border:1px solid #17B330;height: 48px;width: 350px;border-radius:4px">FAÇA SEU LANCE</button>
