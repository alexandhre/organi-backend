                            ...
                            <div class="field">
                                ...
                                <div class="control" style="font-size:12px;color:#868C99">
                                    <label class="checkbox">
                                        <a style="color: #23A7FB" href="/clubeatacado/usuario/esquecisenha">Esqueci a minha senha</a>.
                                    </label>
                                </div>
                            </div>
                            <br>
...
<section class="section">
    <div class="container has-text-left">
        ...
        <p class="textos-1">Aqui você encontrará as categorias que te ajudarão a encontrar os produtos
            ...
            @if ($key <= 2) <div class="column">
                <div class="card" style="box-shadow: 0 0px 0px #ffffff00">
                    ...
                    <div class="card-content" style="position:absolute;top:100px;left:14px">
                        <p class="imagem-titulo">{{$categoria->DS_CATEGORIA_PRODUTO}}</p>
                    </div>
                </div>
        </div>
        @endif
...
<section class="section" style="background-color:#fafafa;">
    <div class="container has-text-left">
        <h1 class="titulos-1" style="width:447px;">Promoções da semana</h1>
    ...
    <div class="container">
        <div class="columns">   
            ...
            <a href="/clubeatacado/recuperarAnuncio/{{$produto->ID_ANUNCIO_PRODUTO}}">           
                ...
                <div class="card" style="box-shadow: 0 0px 0px #ffffff00;background-color:#fafafa;">
                    <div class="card-image">
                        <figure class="image is-rounded" style="text-align: center;">
                            <img class="is-rounded" style="height:66px; width:66px; display:initial" src="{{$produto->DS_FOTO_ANUNCIO_PRODUTO}}">
                        </figure>
                        <div class="content">
                            <p class="subtitle is-6" style="text-align:center;">{{$produto->DS_PRODUTO}}</p>
                            <p class="subtitle is-6 is-danger" style="text-align:center;font-size:12px"><strike>R$ {{$produto->VL_PRODUTO_ANTIGO}}</strike></p>
                            <p class="subtitle" style="text-align:center;font-size:16px;line-height:1.67">R$ {{$produto->VL_PRODUTO_UNITARIO}}</p>
    ...
    <br>
    <section class="section has-text-centered">
        <button onclick="redirecionarPesquisa('promocao')" class="button is-outlined is-success" style="width: 232px;margin-left: 20px" href="perfilusuario.html"> VER
...
<section class="section">
    <div class="container has-text-left">
        <h1 class="titulos-1" style="width:447px;">Qualidade ao melhor preço</h1><br>
        <p class="textos-1">Nós separamos os produtos que são tendência no mercado, exclusivamente
            para você!</p>
    </div>
    <br>
    <div class="container has-text-left">
            ...
            @if ($key <= 2) <div class="column">
                <div class="card" style="box-shadow: 0 0px 0px #ffffff00">
                    <div class="card-image">
                        <figure class="card-home-medium">
                            @if ($produto->IN_PROMOCAO == 1)
                            <div class="container" style="position:absolute; left:20px; width:106px;height:32px;background-color:#FFE500;z-index: 1;">
                                <p class="subtitle is-danger is-6" style="position:absolute; top:8px;right:15px;width:75px;font-weight:bold;">OFERTAS</p>
                            </div>
                            @endif                 
                            <img src="{{$produto->DS_FOTO_ANUNCIO_PRODUTO}}" style="filter: brightness(60%);border-radius: 8px;width: 350px;height: 158px;" alt="Placeholder image">
                        </figure>
                    </div>
                    <div class="card-content" style="position:absolute;top:100px;left:14px">
                    ...
                    <div class="field">
                        <p class="subtitle is-bold is-6 is-left" style="color: black;margin-bottom: 0.5rem;">{{$produto->DS_PRODUTO}}</p>
                        @if ($produto->IN_PROMOCAO == 1)
                    ...
                    <nav class="level">
                      <div class="level-left">
                        <div class="level-item">
                          <a class="button gradiente"><img style="height:27x; width:30px"
                              src="css\img\icons8-favorite-60.png"></a>
                        </div>
                      </div>                     
                    </nav>
                  </div>
    ...
    <section class="section has-text-centered">
        <button onclick="redirecionarPesquisa('produto')" class="button is-outlined is-success" style="width: 232px;margin-left: 20px" href="perfilusuario.html"> VER
            ...
            <div class="column destaque">
                <div class="card" style="box-shadow: 0 0px 0px #ffffff00">
                    ...
                    <div class="card-content" style="position:absolute;bottom:40px;left:40px">
                        ...
                        <a class="button is-success" style="width: 232px;">COMPRAR</a>
                    </div>
                </div>
...
<section class="section">
    ...
    <div class="container has-text-left" style="margin-top:74px;">
        ...
        <div class="card" style="box-shadow: 0 0px 0px #ffffff00">
            <div class="card-image">
                <figure class="IMAGE">
                    <img src="http://i.ytimg.com/vi/GsHO1Fu1bM0/maxresdefault.jpg" style="height:360px; width:1110px;border-radius: 16px;" alt="Placeholder image">
                </figure>
            </div>
        </div>
    </div>
