    ...
    <tr><!-- Outer Table -->
        <td align="center"  bgcolor="#f0f0f0" data-composer>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;" >
                <!-- lotus-header-1 -->
                <tr>
                    <td align="center"  bgcolor="#1b7234" class="container-padding">
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                                                ...
                                                <table border="0" align="right" cellpadding="0" cellspacing="0" role="presentation" class="row" width="280" style="width:280px;max-width:280px;">
                                                    <tr  >
                                                        <td align="left" class="center-text">
                                                            <a href="https://smartpec.dev.myappnow.com.br/login"><img style="width:72px;border:0px;display: inline!important;" src="https://smartpec.dev.myappnow.com.br/img/logobranca.png" width="72" border="0"       alt="logo_"></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <div  >
                                        Clique no botão abaixo para ativar o seu cadastro e poder usufruir dos 
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="center-float">
                                        <tr>
                                            <td align="center"    bgcolor="#d6df58" style="border-radius: 6px;">
                                                ...
                                                <a href="https://smartpec.dev.myappnow.com.br/activate/{{$idUsuario}}" target="_blank"    style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:16px;line-height:19px;font-weight:700;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;padding: 20px 50px 20px 50px;display: inline-block;"><span>Ativar</span></a>
                                            </td>
                                        </tr>
                                    </table>
                                    <!-- Header Button -->
