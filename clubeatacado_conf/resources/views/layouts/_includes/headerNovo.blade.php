...
<div class="container has-text-left">
  ...
  <div class="col-md-12  mt-4" style="background-color: #ffffff;min-height: 45px;">
    <div class="col-md-2 col-lg-2 float-left" style="position: relative;top: 35px;left: 25px;">
    ...
    <div id="navbarExampleTransparentExample" class="col-md-6 float-left" style="position: relative;top: -30px;left: 284px;">
    ...
    <div class="navbar-end" style="top: -55px;margin:0 0 0 0;position: relative;">
