...
class AnuncioController extends Controller
{
    ...
    public function index() {
        ...
        return view('novoAnuncio', compact('anuncio', 'listaTipoProduto', 'listaTipoAnuncio'));    
    }

    public function create(Request $request)
    {       
        $dados =  $this->sharedService->converterRequestToJson($request);          
        $idProduto = $this->produtoService->cadastrarProduto($dados);
        $idAnuncioProduto = $this->anuncioService->cadastrarAnuncio($dados, $idProduto); 
        $this->documentService->cadastrarDocumentos($dados->uploading_files_anuncio, $dados->uploading_files_anexo, $idAnuncioProduto); 
    ...
    {       
        $dados =  $this->sharedService->converterRequestToJson($request);  
        $returnLeilao = $this->leilaoService->deletarLeilao($dados->idAnuncioProduto);
        if($returnLeilao['erro']){
            $response = [
                'error' => true,
