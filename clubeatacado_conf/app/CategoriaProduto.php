...
class Categoria extends Model
{
    ...
    public static function listarTipocategorias(){
        $categoria = DB::table('TB_CATEGORIA_PRODUTO')
            //->join('TB_CATEGORIA_PRODUTO','TB_CATEGORIA_PRODUTO.ID_TIPO_PRODUTO','TB_CATEGORIA_PRODUTO.ID_TIPO_PRODUTO')
            ->select(
                'TB_CATEGORIA_PRODUTO.ID_TIPO_PRODUTO AS tipoId',
                'TB_CATEGORIA_PRODUTO.DS_TIPO_PRODUTO AS tipoCategoria',
                'TB_CATEGORIA_PRODUTO.DS_ICONE_TIPO_PRODUTO AS iconeTipo')
...
//        }
    ...
    public static function listarTipocategoriasWeb(){
        $categoria = DB::table('TB_CATEGORIA_PRODUTO')
           // ->join('TB_CATEGORIA_PRODUTO','TB_CATEGORIA_PRODUTO.ID_TIPO_PRODUTO','TB_CATEGORIA_PRODUTO.ID_TIPO_PRODUTO')
            ->select(
                'TB_CATEGORIA_PRODUTO.ID_TIPO_PRODUTO',
                'DS_TIPO_PRODUTO'
               // ,'TB_CATEGORIA_PRODUTO.DS_CATEGORIA_PRODUTO'
                ,'TB_CATEGORIA_PRODUTO.DS_ICONE_TIPO_PRODUTO'
           )
            ->orderBy('ID_TIPO_PRODUTO','ASC')
            ->get();
        foreach($categoria as $item){
            $item->DS_ICONE_TIPO_PRODUTO = "https://testetendering.myappnow.com.br/clubeatacado\images\categorias\\".$item->DS_ICONE_TIPO_PRODUTO;
        }
    ...
    public static function listarcategorias($id){
        $categoria = DB::table('TB_CATEGORIA_PRODUTO')
    ...
    public static function categoriaBuscada($produto){
        ...
        $listAnuncio = DB::table('TB_CATEGORIA_PRODUTO')
